                                ...
                                <div className="flex-1 space-y-4 text-center md:text-left">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                        ...
                                        <div className="flex flex-col items-center md:items-end">
                                            ...
                                            <p className="text-2xl font-serif font-black text-[#1a1a1a] mt-2">₹{booking.totalAmount}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-4 border-t border-gray-50">
                                        ...
                                        <div className="flex items-center gap-3 justify-center md:justify-start">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-xs font-bold text-[#1a1a1a] truncate max-w-[120px]">Confirmed Visit</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
